...
_TEST_STRUCTURE_VALIDATOR_MISPLACED_TEST_FILE_WHITELIST = []
...
@property
def TEST_STRUCTURE_VALIDATOR_MISPLACED_TEST_FILE_WHITELIST():  # noqa: N802
    """
    The term "Whitelist" will be deprecated in 12.7 and move to "Allowlist".
    Until then, keep this for backwards compatibility but warn users about future deprecation.
    """
    ...
    return _TEST_STRUCTURE_VALIDATOR_MISPLACED_TEST_FILE_WHITELIST


@TEST_STRUCTURE_VALIDATOR_MISPLACED_TEST_FILE_WHITELIST.setter
def TEST_STRUCTURE_VALIDATOR_MISPLACED_TEST_FILE_WHITELIST(value):  # noqa: N802
    """
    The term "Whitelist" will be deprecated in 12.7 and move to "Allowlist".
    Until then, keep this for backwards compatibility but warn users about future deprecation.
    """
