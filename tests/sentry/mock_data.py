SENTRY_EVENT = {
            ...
            'stacktrace': {
                'frames': [{
                    ...
                    'vars': {
                        ...
                        'admin': '<EmailUser: Test User>', 'test_data': '123'
                    },
                    'in_app': True
                }]
            },
    ...
    'request': {
        'url': 'http://localhost:8000/api/v2/test/17/', 'query_string': '', 'method': 'PUT',
        'env': {
            'SERVER_NAME': 'cdc3cb5b00af', 'SERVER_PORT': '8000', 'REMOTE_ADDR': '172.22.0.1'
        },
        'headers': {
            'Content-Length': '1202', 'Content-Type': 'application/json', 'Host': 'localhost:8000',
            ...
            'Origin': 'http://127.0.0.1:3000', 'Dnt': '1', 'Connection': 'keep-alive',
            'Referer': 'http://127.0.0.1:3000/', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Mode': 'cors',
